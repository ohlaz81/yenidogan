...
export function NewsletterBar() {
  ...
  return (
    <section className="border-y border-border bg-accent-pink-soft/40 py-10">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 lg:flex-row lg:items-center">
        ...
        {state.ok ? (
          ...
          <form action={action} className="flex w-full flex-col gap-2 sm:flex-row sm:items-center">
            <input
              ...
              className="h-12 flex-1 rounded-xl border border-border bg-white px-4 text-sm shadow-inner outline-none ring-primary focus:ring-2"
            />
            <button
              type="submit"
              disabled={pending}
